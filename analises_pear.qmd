...
data_PE <- read.csv2("~/pear/data_PE.csv", sep = ",", dec = ",") # 262mil ocorrencias de todas as espécies via GBIF

adapta_pe<-read.csv2("~/pear/DadosBiod.csv", sep = "\t", dec = ",") # Dados do Adapta Brasil sobre Integridade dos Biomas
adapta_pe %>% 
  as_tibble() %>% 
